...
const capitalAccountStatementRoutes = require("./routes/capital-account-statement.routes")
...
app.use(`${config.apiPrefix}/capital-account-statements`, capitalAccountStatementRoutes)
